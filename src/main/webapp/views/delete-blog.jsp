      ...
      <div class="container-fluid">
        <div class="row my-2">
          ...
          <div class="col-12 col-lg-4">
            <h1 class="bg-info p-2 rounded text-center">Удалить блог</h1>
            <form
              method="POST"
              action=""
            ...
            >
              ...
              <div class="form-group">
                ...
                <textarea
                  ...
                  rows="3"
                  readonly
                >${blogsDelete[0].getContent()}</textarea>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input
                  ...
                  name="createdAt"
                  readonly
                  value="${blogsDelete[0].getCreatedAt()}"
                />
              </div>
              <button
                type="submit"
