...
public class EditBlogServlet extends HttpServlet {
  ...
  String edit_blog = "UPDATE blog SET title = ?, content = ?, id_author = ? WHERE id = ?";

  ArrayList<Author> authors = new ArrayList<Author>();
  ArrayList<Blog> blogs = new ArrayList<Blog>();
  ArrayList<Blog> editBlogs = new ArrayList<Blog>();
  String userPath;

  public EditBlogServlet() throws FileNotFoundException, IOException {
    super();
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    try (Connection conn = builder.getConnection()) {
      ...
      try (PreparedStatement preparedStatement = conn.prepareStatement(select_blog_ById)) {
        ...
        if (rs != null) {
          ...
          rs.close();
          request.setAttribute("blogsEdit", editBlogs);
        } else {
          System.out.println("Ошибка загрузки author");
        }
      } catch (Exception e) {
    ...
    RequestDispatcher view = getServletContext().getRequestDispatcher("/views/edit-blog.jsp");
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    try (Connection conn = builder.getConnection()) {
      ...
      PreparedStatement preparedStatement = conn.prepareStatement(edit_blog);
